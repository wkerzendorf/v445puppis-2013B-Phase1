...
\Abstract{V445 Puppis was a unique nova.  Based on its slow lightcurve
 ...
 escape notice.  In the first part of the project we uncovered 
 ( with successful NACO P90 imaging) that the star, enshrouded by dust for years, is finally visible. 
 We propose to scrutinize this object with NACO spectroscopy and study the current state of the system.}
...
\ObservingRun{A}{92}{NACO}{4h}{any}{n}{0.8}{THN}{s}{}
...
\ScientificRationale{
%
 {\em This is the follow-up to the successful P90 proposal ??????}
 ...
 164; Kerzendorf et al.  2012, ApJ, Kerzendorf et al. 2013, subm. ) as well as a lack of
 ...
 The pretty nebula also posed a problem, however, in that the
 equatorial waist obscures the binary. However, new NACO imaging revealed that the dust had "settled" and
 the star is visible again: In 2012, we obtained K-Band images that show that the star is visible with a magnitude of $\textrm{K}=15.5$ (for comparison see Figure~\ref{fig:v445img}) .
 
Pre-explosion V445 Pup had
 $V\simeq14.5$ and $V-K\simeq3.0$. In addition, it was variable at the
 ...
 circumstellar reddening; Woudt et al., ibid). With these information we conclude that currently there's a extinction of $A_\textrm{K} = 4$.
...
\ImmediateObjective{We propose to use 4 hours of NACO AO spectropscopy to
...
In our previous observation run we detected stars magnitude to $K\approx15.5$. 
For constant expansion, the dust column density and
 hence the extinction scale as $\rho R\propto R^{-2}\propto t^{-2}$,
 and thus in late 2013/early 2014 it should be reduced to $K\approx15.3$.
 
 
 We propose two OBs with 0.7 h on target, to get a spectrum with the necessary quality to obtain the aforementioned science goals.
...
\MakeCaption{Fig.~1: NACO observations taken March 2007 by Woudt et
 al. (on the left) and Our observations taken in December 2012 (on the right). The binary is now visible with $K\approx15.5$.}
